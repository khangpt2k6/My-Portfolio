            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-1.5">
                  <div className="w-5 h-5 rounded-lg flex items-center justify-center shrink-0" style={{ background: isAvailable ? "#F0FDF4" : "#F8FAFC", border: `1px solid ${isAvailable ? "#BBF7D0" : "#E2E8F0"}` }}>
                    <svg width="8" height="8" viewBox="0 0 14 14" fill="none">
                      <path d="M2 12V5l5-3.5L12 5v7" stroke={isAvailable ? "#006747" : "#94A3B8"} strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
                      <rect x="5" y="8" width="4" height="4" stroke={isAvailable ? "#006747" : "#94A3B8"} strokeWidth="1" fill="none" rx="0.5" />
                    </svg>
                  </div>
                  <div>
      ...
      <div className="flex items-center justify-around px-2 py-1.5 shrink-0" style={{ borderTop: "1px solid #F1F5F9" }}>
        {[
          ...
          <div key={tab.label} className="flex flex-col items-center gap-0.5">
            <svg width="10" height="10" viewBox="0 0 24 24" fill="none" style={{ color: tab.active ? "#006747" : "#94A3B8" }}>
              {tab.icon}
            </svg>
