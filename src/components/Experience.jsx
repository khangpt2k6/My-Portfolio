    ...
    professional: [
      {
        ...
        description: [
          ...
          "Contributed to developing dynamic dashboards using Redux for state management, improving data visibility and supporting faster decision-making.",
          "Assisted in performance optimization of SQL queries and APIs, contributing to the system handling up to 1,000 concurrent requests during peak load."
        ],
      ...
      },
      {
        ...
        icon: <FaCode />,
        description: [
          "Organized 2 practical workshops on DevOps, attracting up to 200 participants through real-world coding exercises.",
      ...
      },
      {
        ...
        icon: <FaLaptopCode />,
        description: [
          "Worked with 4 student researchers to develop C++ algorithms using OpenCV and Eigen for robotic data processing and path optimization, improving simulation throughput by 2 times for smoother performance.",
          "Automated workflows and executed commands in a Linux environment using Bash, collaborating via GitHub to reduce manual setup time by approximately 50% and improve team productivity and simulation reliability."
        ],
