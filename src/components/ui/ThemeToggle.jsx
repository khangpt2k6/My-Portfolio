 ...
 * Inspired by uiverse.io — features clouds, stars, moon craters, and smooth transitions.
 */
const ThemeToggle = ({ isDark, onToggle }) => {
  return (
    <>
      <label className="tt-switch" aria-label="Toggle theme">
        <input
          type="checkbox"
      ...
      <style>{`
        ...
        /* ── Checked = Dark Mode ── */
        .tt-checkbox:checked + .tt-container {
          background-color: var(--container-night-bg);
        }

        .tt-checkbox:checked + .tt-container .tt-circle {
          left: calc(
            100% - var(--circle-container-offset) - var(--circle-container-diameter)
          );
        }

        .tt-checkbox:checked + .tt-container .tt-circle:hover {
          left: calc(
        ...
        .tt-checkbox:checked + .tt-container .tt-moon {
          transform: translate(0);
        }

        .tt-checkbox:checked + .tt-container .tt-clouds {
          bottom: -4.062em;
        }

        .tt-checkbox:checked + .tt-container .tt-stars {
          top: 50%;
