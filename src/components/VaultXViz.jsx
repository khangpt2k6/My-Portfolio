      ...
      <div className="flex items-center justify-around px-2 py-1.5 shrink-0" style={{ borderTop: "1px solid rgba(56,189,248,0.06)" }}>
        {["Dashboard", "Accounts", "Trading", "Settings"].map((tab, i) => (
          <div key={tab} className="flex flex-col items-center gap-0.5">
            <div className="w-2.5 h-2.5 rounded-sm" style={{ background: i === 0 ? "#38BDF8" : "rgba(56,189,248,0.1)", boxShadow: i === 0 ? "0 0 6px rgba(56,189,248,0.3)" : "none" }} />
            <span style={{ fontSize: "4px", color: i === 0 ? "#38BDF8" : "rgba(148,197,248,0.25)" }}>{tab}</span>
          </div>
        ))}
      </div>
